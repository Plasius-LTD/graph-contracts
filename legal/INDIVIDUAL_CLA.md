...
**Project:** @plasius/graph-contracts (Plasius LTD)  
...
- **"Project"** means the @plasius/graph-contracts repositories and related materials owned or managed by **Plasius LTD**.
